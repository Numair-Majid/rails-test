  ...
  class JobApplicationsController < BaseController
    ...
    def update
      if job_application.update(updation_params)
        ...
        render json: job_application.errors.full_messages, status: :unprocessable_entity
      end
    end
    ...
    def collection
      @collection ||= JobApplicationsCollection.new(current_user.job_applications.not_withdrawn, filter_params).results
    end
